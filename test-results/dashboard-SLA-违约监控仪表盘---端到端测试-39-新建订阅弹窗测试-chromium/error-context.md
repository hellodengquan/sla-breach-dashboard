...
- Name: dashboard.spec.js >> SLA 违约监控仪表盘 - 端到端测试 >> 39. 新建订阅弹窗测试
- Location: tests/e2e/dashboard.spec.js:555:3
...
Locator: getByText('新建订阅')
Expected: visible
Error: strict mode violation: getByText('新建订阅') resolved to 2 elements:
    1) <button class="btn btn-primary btn-sm">+ 新建订阅</button> aka getByRole('button', { name: '+ 新建订阅' })
    2) <h3>新建订阅</h3> aka getByRole('heading', { name: '新建订阅' })

Call log:
  - Expect "toBeVisible" with timeout 5000ms
  - waiting for getByText('新建订阅')
  ...
  - generic [ref=e3]:
    - banner [ref=e4]:
      - generic [ref=e5]:
        ...
        - paragraph [ref=e7]:
          - text: "实时监控客服工单 SLA 超时情况 · 更新于 2026/6/15 14:32:21 · 当前用户:"
          - strong [ref=e8]: 张三
          - generic [ref=e9]: (管理员)
      - generic [ref=e10]:
    ...
    - main [ref=e24]:
      - generic [ref=e25]:
        - generic [ref=e26]:
          ...
          - button "+ 新建订阅" [active] [ref=e28] [cursor=pointer]
        - generic [ref=e29]:
          - generic [ref=e30]:
            - generic [ref=e31]: "5"
        ...
        - generic [ref=e126]:
          - heading "新建订阅" [level=3] [ref=e127]
          - generic [ref=e128]:
            - generic [ref=e129]: 订阅名称
            - textbox "输入订阅名称" [ref=e130]
          - generic [ref=e131]:
            - generic [ref=e132]: 订阅类型
            - combobox [ref=e133]:
              - option "日报" [selected]
              - option "周报"
              - option "月报"
              ...
              - option "预算告警"
          - generic [ref=e134]:
            - generic [ref=e135]: 报告类型
            - combobox [ref=e136]:
              - option "摘要报告" [selected]
              - option "完整报告"
              - option "告警报告"
          - generic [ref=e137]:
            - generic [ref=e138]: 推送渠道
            - generic [ref=e139]:
              - generic [ref=e141] [cursor=pointer]: 📧 邮件
              - generic [ref=e143] [cursor=pointer]: 🔗 Webhook
              - generic [ref=e145] [cursor=pointer]: 📱 短信
          - generic [ref=e146]:
            - generic [ref=e147]: 发送时间
            - textbox [ref=e148]: 09:00
          - generic [ref=e149]:
            - generic [ref=e150]: 收件人
            - textbox "email@example.com" [ref=e152]
            - button "+ 添加收件人" [ref=e153] [cursor=pointer]
          - generic [ref=e154]:
            - button "取消" [ref=e155] [cursor=pointer]
            - button "创建订阅" [disabled] [ref=e156]
  - generic [ref=e157]: "0"
```
